...
class _DeletePayableDialogState extends State<DeletePayableDialog> with SingleTickerProviderStateMixin {
  ...
  void _handleDelete() async {
    final provider = Provider.of<PayablesProvider>(context, listen: false);

    await provider.deletePayable(widget.payable.id);
