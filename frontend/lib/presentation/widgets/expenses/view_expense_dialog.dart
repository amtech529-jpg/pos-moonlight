...
class _ViewExpenseDetailsDialogState extends State<ViewExpenseDetailsDialog>
  ...
  Widget _buildSettingsCard(bool isCompact) {
    return Container(
      padding: EdgeInsets.all(context.cardPadding),
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildSettingItem(Icons.repeat, 'Recurring', widget.expense.isRecurring),
  ...
  Widget _buildSettingItem(IconData icon, String label, bool value) {
    return Row(
      children: [
        Icon(
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: context.bodyFontSize,
            color: value ? AppTheme.charcoalGray : Colors.grey,
